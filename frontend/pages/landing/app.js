...
document.addEventListener('mousemove', e => {
    ...
    dot.style.cssText = `width:${size}px;height:${size}px;left:${mouse.x - size/2}px;top:${mouse.y - size/2}px;opacity:0.8;transition:opacity 1s,transform 1s; background: #50C878; box-shadow: 0 0 10px #50C878;`;
...
window.addEventListener('load', () => {
    document.querySelector('.maindiv').classList.add('reveal');
    document.querySelector('.stats-ribbon').classList.add('reveal');
});